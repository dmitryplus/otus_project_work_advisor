# test_ocr.py
# Проверка получения описания элементов на картинке
...
relevants = rag_service.search_relevant_documents(recognized_text, top_k=3)
...
if not relevants:
    ...
    response = llm_service.generate_response(question=recognized_text, context=context)
